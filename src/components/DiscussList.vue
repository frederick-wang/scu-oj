      ...
      <div class="container">
        <div class="am-g am-g-fixed">
          <div class="am-u-sm-12">
            <div class="card discuss-list-header">
              <div class="content">
...
.discuss-list-header .discuss-list-left {
  float: left;
}

.discuss-list-header .buttons {
  position: absolute;
  right: 0;
  top: 50%;
  transform: translateY(-50%);
...
.discuss-list-header .buttons .item:first-child {
  margin-right: 0;
}

.discuss-list-header .buttons .item {
  float: right;
  margin: 0 1rem;
  opacity: 0.5;
...
.discuss-list-header .buttons .item:hover,
.discuss-list-header .buttons .item:focus {
  opacity: 1;
}
