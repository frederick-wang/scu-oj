...
.discuss-header .discuss-information {
  float: left;
}

.discuss-header .buttons {
  position: absolute;
  right: 0;
  top: 50%;
...
.discuss-header .buttons .item:first-child {
  margin-right: 0;
}

.discuss-header .buttons .item {
  float: right;
  margin: 0 1rem;
  opacity: 0.5;
...
.discuss-header .buttons .item:hover,
.discuss-header .buttons .item:focus {
  opacity: 1;
}
</style>
